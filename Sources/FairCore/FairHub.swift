...
public extension FairHub {
    ...
    enum Errors : LocalizedError {
        ...
        public var errorDescription: String? {
            ...
            case .noVerification(let info): return "No verification information for commit ref: \"\(info.repository.object.abbreviatedOid)\""
            ...
            case .noAuthor(let info): return "The author was empty for the commit: \"\(info.repository.object.abbreviatedOid)\""
