...
precondition(package.dependencies[0].url == "https://appfair.org/Fair.git", "first Package.swift dependency must be 'https://appfair.org/Fair.git', but was: '\(package.dependencies[0].url)'")
