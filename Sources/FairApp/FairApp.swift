...
private final class AppDelegate: NSObject, UXApplicationDelegate {
    ...
    func applicationWillFinishLaunching(_ notification: Notification) {
        ...
        if Bundle.main.infoDictionary?["CFBundleIcons"] == nil
            && Bundle.main.infoDictionary?["CFBundleIconFile"] == nil
            && Bundle.main.infoDictionary?["CFBundleIconName"] == nil {
            NSApp.dockTile.contentView = createAppIconView(span: 120).viewWrapper()
    ...
    private func createAppIconView(span: CGFloat) -> some View {
        ...
        return FairIconView(Bundle.main.bundleName ?? "", subtitle: "", paths: paths, iconColor: Color.accentColor, borderRatio: 0.0).iconView(for: span)
    }
